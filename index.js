...
function checkResult(guessingNumber) {
    ...
    if (guessingNumber === randomNumber) {
        resultText.innerHTML = `you have won: selected numb : ${guessingNumber}  random numb: ${randomNumber}`;
        totalWons++;
    } else {
        resultText.innerHTML = `you have lost; selected numb : ${guessingNumber}  random numb: ${randomNumber}`;
        totallosts++;
    }
